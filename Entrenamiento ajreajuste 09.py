...
df = pd.read_csv('C:/Users/ricar/Google Drive/Proyecto de titulo Ana Javiera/PT/dataset1.12.csv', sep=";") # almacenamiento en datagrama
...
# Define el criterio de parada temprana
early_stopping = EarlyStopping(monitor='val_loss', patience=10)

# Construyendo la red
model_2 = Sequential([
    Dense(101, activation='tanh', input_shape=(10,)),
    Dense(301, activation='relu'),
    Dense(200, activation='tanh'),
    Dense(101, activation='tanh'),
...
hist = model_2.fit(X_train, Y_train, batch_size=32, epochs=200, validation_data=(X_test, Y_test))
